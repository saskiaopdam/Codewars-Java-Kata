...
//            123
            ...
            if ((position + length + expectedLength) > (input.length() - 1)) {
                System.out.println("string index will be out of bounds");
                System.out.println("endindexofnext: " + (position + length + expectedLength));
                System.out.println("endindexofstring: " + (input.length() - 1));
                System.out.println("string");
//checkmissingnumbersofgaopnieuwmetinitialLength+1
...
//            }
        ...
        System.out.println("missingnumberslist: " + missingNumbers);
        System.out.println("missingnumber: " + (missingNumbers.size() == 1 ? missingNumbers.get(0) : -1));
        return missingNumbers.size() == 1 ? missingNumbers.get(0) : -1;
    }
}